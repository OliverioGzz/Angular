...
export class DialogVentaComponent {
    ...
    constructor(
        ...
        this.conceptos = [];
        this.venta = { idCliente: 2002, conceptos: [] } //Valores por defecto de prueba
    }
    ...
    addConcepto(){
        this.conceptos.push(this.conceptoForm.value as Concepto); //Marca error por tener null | undefined
    }
